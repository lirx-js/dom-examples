...
import { ITodoListItem, ITodoListItemsList } from '../todo-list.types';


// @ts-ignore
import html from './todo-list-with-observables.component.html?raw';
// @ts-ignore
import style from './todo-list.component.scss?inline';

/**
 * COMPONENT: 'app-todo-list-with-observables'
 **/
...
export const TodoListWithObservablesComponent = new Component({
  name: 'app-todo-list-with-observables',
